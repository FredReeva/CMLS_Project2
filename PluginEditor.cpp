    ...
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    // volume
    //toneLabel.setText("Volume",dontSendNotification);
...
void DistortionAudioProcessorEditor::resized()
{
    ...
    //gainLabel.setBounds(0,100,100,20);
    gainPot.setBounds(50,50,100,100);
    
    //toneLabel.setBounds(100,100,100,20);
    tonePot.setBounds(150,50,100,100);
    
    //volumeLabel.setBounds(200,100,100,20);
    volumePot.setBounds(250,50,100,100);

}

// function that will be called when the pot value is changed (and will actually change the variable)
